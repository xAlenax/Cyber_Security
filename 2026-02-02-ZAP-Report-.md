...
| Info | Informational | http://localhost:8001 | Percentage of responses with status code 2xx | 25 % |
| Info | Informational | http://localhost:8001 | Percentage of responses with status code 3xx | 5 % |
| Info | Exceeded Low | http://localhost:8001 | Percentage of responses with status code 4xx | 22 % |
| Info | Exceeded Low | http://localhost:8001 | Percentage of responses with status code 5xx | 47 % |
| Info | Informational | http://localhost:8001 | Percentage of endpoints with content type text/css | 8 % |
| Info | Informational | http://localhost:8001 | Percentage of endpoints with content type text/html | 16 % |
| Info | Informational | http://localhost:8001 | Percentage of endpoints with content type text/javascript | 16 % |
| Info | Informational | http://localhost:8001 | Percentage of endpoints with content type text/plain | 41 % |
| Info | Informational | http://localhost:8001 | Percentage of endpoints with method GET | 91 % |
| Info | Informational | http://localhost:8001 | Percentage of endpoints with method POST | 8 % |
| Info | Informational | http://localhost:8001 | Count of total endpoints | 12    |
